...
const GhostDraftGenerator: React.FC = () => {
  ...
  const allFilesReady = docxFile && csvFile && xsdFile;
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
        ...
        <div className="flex items-center gap-3">
          ...
          {result && (
            <button onClick={handleReset} className="px-4 py-2.5 text-slate-600 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 text-sm font-medium transition-colors">
              Reset
            </button>
          )}
        </div>
